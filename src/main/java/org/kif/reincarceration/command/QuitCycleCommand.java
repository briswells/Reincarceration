...
public class QuitCycleCommand  implements CommandExecutor {
    private final CycleManager cycleManager;

    public QuitCycleCommand(CommandModule commandModule, ConfigManager configManager, CycleModule cycleModule) {
